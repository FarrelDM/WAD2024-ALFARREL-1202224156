    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('lecturers.update', $lecturer->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="lecturers_code" name="lecturers_code" value="{{ $lecturer->lecturers_code }}" required>
            </div>
            <div class="mb-3">
                <label for="lecturers_name" class="form-label">Lecturer Name</label>
                <input type="text" class="form-control" id="lecturers_name" name="lecturers_name" value="{{ $lecturer->lecturers_name }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="telephone_number" name="telephone_number" value="{{ $lecturer->telephone_number }}" required>
            </div>
